...
FORMULAE="bash-completion openssl rename git git-flow watchman watch imagemagick jmeter jq ruby pyenv yarn tfenv packer php tree pkg-config cairo pango libpng jpeg giflib librsvg lftp figlet kubectl helm bat"
