...
FORMULAE="bash-completion openssl rename git-flow watchman watch imagemagick jmeter jq ruby pyenv yarn warrensbox/tap/tfswitch packer php tree pkg-config cairo pango libpng jpeg giflib librsvg"
